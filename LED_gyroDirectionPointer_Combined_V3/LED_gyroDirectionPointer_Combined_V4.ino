...
void loop() {
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
    ...
    if (accel_avg > 50 && LED_Direction > 8 && LED_Direction != 16){
      // Right Click
      Serial.println("RC");
      delay(500);
    }
    else if (accel_avg > 50 && LED_Direction > 0) {
      // Left Click
      Serial.println("LC");
      delay(500);
    }
    else if (LED_Direction == 3 || LED_Direction == 2) {
      Serial.println("SW"); // South - west
    }
    else if (LED_Direction == 5 || LED_Direction == 4) {
      Serial.println("W"); // West
    }
    else if (LED_Direction == 7 || LED_Direction == 6) {
      Serial.println("NW"); // North West
    }
    else if (LED_Direction == 9 || LED_Direction == 8) {
      Serial.println("N"); // North
    }
    else if (LED_Direction == 11 || LED_Direction == 10) {
      Serial.println("NE"); // North East
    }
    else if (LED_Direction == 13 || LED_Direction == 12) {
      Serial.println("E"); // East
    }
    else if (LED_Direction == 15 || LED_Direction == 14) {
      Serial.println("SE"); // South East
    }
    else if (LED_Direction == 1 || LED_Direction == 0) {
      Serial.println("S"); // South
    }
    else {
      Serial.println("C"); // Balanced
    }
//    Serial.println(LED_Direction);
  ...
  int getLED_Direction(float rot[]) {
    ...
    if (abs(roll) < 25 && abs(pitch) < 15) { // balanced
      return 16;
    }
    else if (LED_angle > 168.75 || LED_angle <= -168.75) {
      return 4;
    }
    else if (LED_angle > -168.75 && LED_angle <= -146.25) {
      return 5;
    }
    else if (LED_angle > -146.25 && LED_angle <= -123.75) {
      return 6;
    }
    else if (LED_angle > -123.75 && LED_angle <= -101.25) {
      return 7;
    }
    else if (LED_angle > -101.25 && LED_angle <= -78.25) {
      return 8;
    }
    else if (LED_angle > -78.75 && LED_angle <= -56.25) {
      return 9;
    }
    else if (LED_angle > -56.25 && LED_angle <= -33.75) {
      return 10;
    }
    else if (LED_angle > -33.75 && LED_angle <= -11.25) {
      return 11;
    }
    else if (LED_angle > -11.25 && LED_angle <= 11.25) {
      return 12;
    }
    else if (LED_angle > 11.25 && LED_angle <= 33.75) {
      return 13;
    }
    else if (LED_angle > 33.75 && LED_angle <= 56.25) {
      return 14;
    }
    else if (LED_angle > 56.25 && LED_angle <= 78.75) {
      return 15;
    }
    else if (LED_angle > 78.75 && LED_angle <= 101.25) {
      return 0;
    }
    else if (LED_angle > 101.25 && LED_angle <= 123.75) {
      return 1;
    }
    else if (LED_angle > 123.25 && LED_angle <= 146.25) {
      return 2;
    }
    else if (LED_angle > 146.25 && LED_angle <= 168.75) {
      return 3;
    }
